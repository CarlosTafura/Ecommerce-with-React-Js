...
console.log(cart);
  ...
  {cart.map(element =>{
    ...
    return <li>Producto:{element.title}- cant:{element.qty}- precio unitario: {element.price} - precio total : {element.price * element.qty}</li>})}
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <div class="p-2">
                                ...
                                <img src={element.image}alt="" width="70" class="img-fluid rounded shadow-sm" />
                                </Link>
                                <div class="ms-3 d-inline-block align-middle">
                                <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">{element.title}</a></h5>
                                </div>
                            </div>
                            </th>
                            <td class="border-0 align-middle"><strong>$ {element.price}</strong></td>
                            <td class="border-0 align-middle"><strong>$ {element.price * element.qty}</strong></td>
                            <td class="border-0 align-middle"><strong>{element.qty}</strong></td>                         
